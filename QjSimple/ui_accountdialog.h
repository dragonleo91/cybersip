...
public:
    ...
    {
        AccountDialogClass->setWindowTitle(QApplication::translate("AccountDialogClass", "SIP Account Settings", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("AccountDialogClass", "SIP domain:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        domainEdit->setToolTip(QApplication::translate("AccountDialogClass", "the domain of your SIP address (e.g. fwd.pulver.com or iptel.org)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("AccountDialogClass", "SIP user name:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        usernameEdit->setToolTip(QApplication::translate("AccountDialogClass", "username of your SIP address (without domain, unless this is explicitely required by the SIP service)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("AccountDialogClass", "SIP password:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        passwordEdit->setToolTip(QApplication::translate("AccountDialogClass", "the password of your SIP account", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_4->setText(QApplication::translate("AccountDialogClass", "STUN server:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        stunEdit->setToolTip(QApplication::translate("AccountDialogClass", "optional: STUN server. If set, this will activate client-based NAT traversal", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_5->setText(QApplication::translate("AccountDialogClass", "Outbound Proxy:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        outboundproxyEdit->setToolTip(QApplication::translate("AccountDialogClass", "IPv4 optional, IPv6 mandatory: enter outbound proxy domain <br>name or IP address (without 'sip:', Note: ';lr' <br>parameter will be added automatically and 'transport' <br>parameter will be added according to protocol <br>selection); e.g: 'sip.example.com', '[2A02:8::C0:8A:D0:D]'; <br>Note: IPv6 requires an IP address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_6->setText(QApplication::translate("AccountDialogClass", "Protocol:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        transportComboBox->setToolTip(QApplication::translate("AccountDialogClass", "the choosen transport protocol for SIP; Note: If you choose an IPv6 transport you have to configure the outbound proxy with an IPv6 IP address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_7->setText(QApplication::translate("AccountDialogClass", "SRTP:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        srtpComboBox->setToolTip(QApplication::translate("AccountDialogClass", "specify if SRTP is completely disabled (reject incoming SAVP SDP), optional (accept SAVP and AVP, send AVP) or mandatory (accept/send SAVP SDP)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_8->setText(QApplication::translate("AccountDialogClass", "SRTP SIP requirements:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        srtpReqComboBox->setToolTip(QApplication::translate("AccountDialogClass", "whether SRTP requires secure signaling to the proxy (TLS), end-to-end (SIPS) or none", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_9->setText(QApplication::translate("AccountDialogClass", "TLS CA file:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        tlsCaFileEdit->setToolTip(QApplication::translate("AccountDialogClass", "optional: the CA certificate file which contains all the CAs which are trusted; this is needed when \"verify TLS server certificate\" is activated", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        caPushButton->setText(QApplication::translate("AccountDialogClass", "Browse", 0, QApplication::UnicodeUTF8));
        label_10->setText(QApplication::translate("AccountDialogClass", "TLS private key file:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        tlsPrivKeyFileEdit->setToolTip(QApplication::translate("AccountDialogClass", "optional: the private key of the SIP client (needed when the SIP Proxy requires a TLS certificate from the client (mutual TLS))", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        privKeyPushButton->setText(QApplication::translate("AccountDialogClass", "Browse", 0, QApplication::UnicodeUTF8));
        label_11->setText(QApplication::translate("AccountDialogClass", "TLS certificate file:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        tlsCertFileEdit->setToolTip(QApplication::translate("AccountDialogClass", "optional: the certificate of the SIP client (needed when the SIP Proxy requires a TLS certificate from the client (mutual TLS))", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        certPushButton->setText(QApplication::translate("AccountDialogClass", "Browse", 0, QApplication::UnicodeUTF8));
        label_12->setText(QApplication::translate("AccountDialogClass", "Logfile:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        logFileEdit->setToolTip(QApplication::translate("AccountDialogClass", "optional: if a file is chosen, the logging will also be written to the specified file", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        logFilePushButton->setText(QApplication::translate("AccountDialogClass", "Browse", 0, QApplication::UnicodeUTF8));
        label_13->setText(QApplication::translate("AccountDialogClass", "XCAP URL:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        xcapUrlEdit->setToolTip(QApplication::translate("AccountDialogClass", "The XCAP URL (used for storing the buddylist)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        xcapUrlEdit->setText(QApplication::translate("AccountDialogClass", "--- not implemented yet ---", 0, QApplication::UnicodeUTF8));
        label_14->setText(QApplication::translate("AccountDialogClass", "Log Level:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        logLevelComboBox->setToolTip(QApplication::translate("AccountDialogClass", "the choosen transport protocol for SIP", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_15->setText(QApplication::translate("AccountDialogClass", "Local SIP Port:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        sipPortSpinBox->setToolTip(QApplication::translate("AccountDialogClass", "Set 0 to use a random SIP port!", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        noregistrationBox->setText(QApplication::translate("AccountDialogClass", "do not REGISTER", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        tlsVerifyServerBox->setToolTip(QApplication::translate("AccountDialogClass", "if this checkbox is enabled, the certificate presented by the SIP proxy will be validated against the certification authorities in the CA file", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        tlsVerifyServerBox->setText(QApplication::translate("AccountDialogClass", "verify TLS server certificate", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        subscribeBox->setToolTip(QApplication::translate("AccountDialogClass", "if this checkbox is enabled, the SIP client SUBSCRIBE to the buddies presence", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        subscribeBox->setText(QApplication::translate("AccountDialogClass", "SUBSCRIBE buddies", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        publishBox->setToolTip(QApplication::translate("AccountDialogClass", "if this checkbox is enabled, the SIP client sends PUBLISH requests to send its presence state to the presence server", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        publishBox->setText(QApplication::translate("AccountDialogClass", "PUBLISH presence state", 0, QApplication::UnicodeUTF8));
        okButton->setText(QApplication::translate("AccountDialogClass", "OK", 0, QApplication::UnicodeUTF8));
        cancelButton->setText(QApplication::translate("AccountDialogClass", "Cancel", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
