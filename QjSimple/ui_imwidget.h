...
public:
    ...
    {
        ImWidgetClass->setWindowTitle(QApplication::translate("ImWidgetClass", "ImWidget", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("ImWidgetClass", "Instant Messaging History", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        historyEdit->setToolTip(QApplication::translate("ImWidgetClass", "Instant message history", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        textEdit->setToolTip(QApplication::translate("ImWidgetClass", "enter here the text you want to send", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        sendButton->setText(QApplication::translate("ImWidgetClass", "send message", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
